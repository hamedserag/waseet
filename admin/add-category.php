...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = 1;
        $query = mysqli_query($con, "insert into tblcategory(CategoryName,Description,Is_Active,categoryColor) values('$category','$description','$status','$categoryColor')");
        if ($query) {
...
?>
    ...
    <head>
        ...
        <title>الوسيط | Add Category</title>
                                        ...
                                        <div class="col-md-6">
                                            <form class="form-horizontal" name="category" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" value="" name="categoryColor" required>
                                                    </div>
                                                </div>
