...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "Update  tblcategory set CategoryName='$category',Description='$description' where id='$catid',categoryColor='$categoryColor'");
        if ($query) {
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <?php
                                    $catid = intval($_GET['cid']);
                                    $query = mysqli_query($con, "Select id,CategoryName,categoryColor,Description,PostingDate,UpdationDate from  tblcategory where Is_Active=1 and id='$catid'");
                                    $cnt = 1;
                                            ...
                                            <div class="col-md-6">
                                                <form class="form-horizontal" name="category" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" value="<?php echo htmlentities($row['categoryColor']); ?>" name="categoryColor" required>
                                                        </div>
                                                    </div>
